...
def comp_HUFFYUV(input_path,output_path):       #Support only Lossless compression
    ...
    subprocess.run([ffmpeg_executable,"-framerate", "120","-i", input_file,"-c:v", "huffyuv",output_file])
