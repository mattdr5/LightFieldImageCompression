...
def comp_Lagarith(input_path, output_path):
    ...
    # Call ffmpeg to compress the video with Lagarith codec
    subprocess.run([ffmpeg_executable, "-i", input_file, "-c:v", "lagarith", output_file])
