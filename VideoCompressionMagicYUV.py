...
def comp_MagicYUV(input_path, output_path):          #Support only Lossless compression
    ...
    # Call ffmpeg to compress the video with MagicYUV codec
    subprocess.run([ffmpeg_executable, "-framerate", "120","-i", input_file, "-c:v", "magicyuv", output_file])
